    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Inspect and pin target repository identity before creating a worker",
          "Bind workers to a durable supervisor inbox and send stable decision notices",
        ],
        apiSymbols: [
          "BbPluginApi",
          "PluginServerApi",
          "ThreadsArea.experimental_inspectSource",
          "ThreadsArea.experimental_registerSupervisor",
          "ThreadsArea.experimental_supervisorInbox",
          "ThreadsArea.experimental_supervisorPeek",
          "ProvidersArea.experimental_probe",
          "ThreadsArea.experimental_notifySupervisor",
          "ThreadSpawnArgs.experimental_sourcePin",
          "ThreadSpawnArgs.experimental_supervisor",
        ],
        firstParty: [
          "Automations",
          "Docs",
